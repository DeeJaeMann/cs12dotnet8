...
using System.Runtime.CompilerServices; // For DbSet<T>
...
partial class Program
{
    ...
    private static void AggregateProducts()
    {
        ...
        {
            WriteLine($"{"Product count from DeSet:",-25} {countDbSet,10}");
        }
        else
        {
    ...
    {
        // Order data before skipping and taking to ensure the data is not randomly sorted in each page
